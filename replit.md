...
- **iOS Distribution**: Bundle ID com.huntergames.pumpkinpatch with "Apple Connect App Mgr" integration and "PumpkinPatch" provisioning profile for App Store Connect (App ID: 6749664824)