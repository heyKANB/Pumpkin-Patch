...
export default function Marketplace({ player }: MarketplaceProps) {
  ...
  const marketItems: MarketItem[] = [
    ...
    },
    {
      ...
      sellPrice: 4,
      icon: <span className="text-2xl">🌳</span>,
      playerQuantity: player.appleSeeds,
      canBuy: true,
      canSell: player.appleSeeds > 0,
    },
    {
      id: "pumpkins",
      name: "Pumpkins",
    ...
    },
    {
      id: "apples",
      name: "Apples",
      description: "Fresh harvested apples",
      sellPrice: 15,
      icon: <span className="text-2xl">🍎</span>,
      playerQuantity: player.apples,
      canBuy: false,
      canSell: player.apples > 0,
    },
    {
      id: "pies",
      name: "Pumpkin Pies",
    ...
    },
    {
      id: "apple-pies",
      name: "Apple Pies",
      description: "Sweet baked apple pies",
      sellPrice: 25,
      icon: <span className="text-2xl">🍎🥧</span>,
      playerQuantity: player.applePies,
      canBuy: false,
      canSell: player.applePies > 0,
    },
    {
      id: "fertilizer",
      name: "Fertilizer",
